...
async function shareThisQuiz() {
    ...
    Sweetalert2.fire({
        title: 'Share',
        html: `<span id="main-copy-text2">${shareMessage}</span><br><input type="text" readonly="readonly" id="finished-url2" onclick="copyQuizURL()" style="width: 400px;margin: 10px;font-size: 15px;"value="${finalString}"><br>${shareButtons}`,
        icon: 'success',
